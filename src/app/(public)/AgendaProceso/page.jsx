        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-100 via-slate-50 to-slate-100 px-4 py-10 sm:px-6 lg:px-8">
            <div className="mx-auto w-full max-w-3xl">
                <header className="mb-6 flex flex-col items-center gap-2 text-center">
                    <h1
                        className={`${michroma.className} text-3xl sm:text-4xl font-black tracking-widest text-cyan-700`}
                    >
                        MedifyClinic
                    </h1>
                    <h2 className={`${michroma.className} text-lg font-semibold tracking-wide text-cyan-700`}>
                        AgendaOnline
                    </h2>

                    <p className="max-w-md text-sm leading-6 text-slate-500">
                        Reserva tu hora en segundos. Selecciona fecha y un bloque horario disponible.
                    </p>
                </header>
