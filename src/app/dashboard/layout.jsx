                    ...
                    <div className="px-5 py-5 border-b border-white/10 shrink-0">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="leading-tight">
                                <div className="text-2xl font-semibold tracking-wide">MedifyClinic</div>
                                <div className="text-[13px] font-semibold tracking-wide text-white/60">Panel Administrador</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="md:hidden sticky top-0 z-40 border-b border-slate-200 bg-white/85 backdrop-blur">
                        <div className="px-4 py-3 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-semibold text-slate-900">MedifyClinic</span>
                            </div>
                            <div className="text-xs font-semibold text-slate-500">Clínica en la nube</div>
                        </div>
